...
const HomeContent = () => {
    return (
        <div className="w-full">
            <Navbar/>
            <main className="font-gooflex text-white m-auto">
                <div className="section-1 min-h-screen container m-auto flex flex-col items-center bg-red-5000">
                    <h1 className="w-[50%] text-8xl font-bold text-center mt-46">Fund your creative work</h1>
