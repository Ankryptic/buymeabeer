                ...
                <div className="right-main flex flex-col h-[75%] items-center justify-center">
                    ...
                    <div className={`email-pass ${buttonClick === 1 ? "flex" : "hidden"} w-1/2 flex flex-col items-center justify-center px-20`}>
                        ...
                        <div className="signIn-btns w-full flex flex-col gap-2">
                            ...
                            <button
                                className="cursor-pointer flex items-center text-center bg-[#2f2d41] border border-[#0d0d12] rounded-lg shadow-md w-full px-6 pl-25 py-2 text-sm font-medium text-white hover:text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={() => signIn("github")}>
                                <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
