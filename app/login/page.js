            ...
            <div>
                ...
                <div className='w-[30%] px-10 m-auto text-white bg-red-700s container flex flex-col items-center'>
                    ...
                    <div className='flex items-center w-full m-8'>
                        ...
                        <span className='w-full text-center text-sm'>or login with</span>
                        <span className='bg-[#0d0d12] w-full h-0.5'></span>
                    </div>

                    <div className="flex flex-col gap-2">
                        <button
                            className="cursor-pointer flex items-center text-center bg-[#2f2d41] border border-[#0d0d12] rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        ...
                        <button
                            className="cursor-pointer flex items-center text-center bg-[#2f2d41] border border-[#0d0d12] rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={() => signIn("github")}>
                            <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
